...
my $colorClassNamePublic = $magenta;
my $colorClassNameProtected = $magenta;
my $colorClassNamePrivate = $magenta;
my $colorTypeNamePublic = $blue;
my $colorTypeNameProtected = $blue;
my $colorTypeNamePrivate = $blue;
my $colorFunctionPublic = $maroon;
my $colorFunctionProtected = $yellow;
my $colorFunctionPrivate = $tomato;
my $colorMemberPublic = $black;
my $colorMemberProtected = $black;
my $colorMemberPrivate = $black;
my $colorVariablePublic = $tan;
my $colorVariableProtected = $goldenrod;
my $colorVariablePrivate = $yellowgreen;
...
sub main  {
	...
	print OUTPUT "highlight default IDE_$ide"."ClassName $boldterm ctermfg=6 guifg=$colorClassNamePublic\n";
	print OUTPUT "highlight default IDE_$ide"."ClassNamePublic $boldterm ctermfg=6 guifg=$colorClassNamePublic\n";
	print OUTPUT "highlight default IDE_$ide"."ClassNameProtected $boldterm ctermfg=6 guifg=$colorClassNameProtected\n";
	print OUTPUT "highlight default IDE_$ide"."ClassNamePrivate $boldterm ctermfg=6 guifg=$colorClassNamePrivate\n";
	print OUTPUT "highlight default IDE_$ide"."TypeName ctermfg=6 guifg=$colorTypeNamePublic\n";
	print OUTPUT "highlight default IDE_$ide"."TypeNamePublic ctermfg=6 guifg=$colorTypeNamePublic\n";
	print OUTPUT "highlight default IDE_$ide"."TypeNameProtected ctermfg=6 guifg=$colorTypeNameProtected\n";
	print OUTPUT "highlight default IDE_$ide"."TypeNamePrivate ctermfg=6 guifg=$colorTypeNamePrivate\n";
	...
	foreach my $atgroup (@group_table_sorted) {		
		...
		} elsif (($item eq "typedef") || ($item eq "enum") || ($item eq "struct") || ($item eq "namespace")) {
